...
SC_MODULE( hazard )
{
  public: 
    ...
    sc_in< bool >  RegWrite_wb,  MemRead_mem , MemRead_exe, RegWrite_exe, RegWrite_mem , mem_read /*, RegWrite*/;        
    ...
    {      
		...
		<< WriteReg_mem << RegWrite_mem << mem_read << /*WriteReg_id2 <<*/ MemRead_exe << MemRead_mem
