...
#include "regfile.h"
#include "alu.h"
//#include "branchcontrol.h" //agora jump control
...
SC_MODULE(mips) {
   ...
   //EXE
   alu               *alu1;      // ALU
   mux< sc_uint<32> > *m1, *muxrs, *muxRTfwd;       // selects 2nd ALU operand
   ...
   mux4bool< sc_uint<32> > *mx41; 
   mux4bool< sc_uint<32> > *mx42; 
   mux4bool< sc_uint<32> > *mx43; 
   mux4bool< sc_uint<32> > *mx44; 
   ...
   sc_signal < sc_uint<5> > rt_id2, rd_id2, rs_id2, rt_exe, rt_mem, rs_exe;
   ...
   //MEM
   sc_signal < sc_uint<32> > MemOut, RTfwd;   // data memory output
   ...
   sc_signal < sc_uint<2> > JumpTaken;  
   sc_signal < sc_uint<32> > const0;      // execute branch
   sc_signal < sc_uint<32> > const4;   // contant 4
   sc_signal < bool > const1;          // contant 4


   // sinais usados no forwarding

   sc_signal <bool> rsId1, rsId2, rtId1, rtId2, rsExe1, rsExe2, rtExe1,rtExe2, rtMem, selMem; 

   sc_signal < sc_uint<32> >  m43dout, m44dout; 
