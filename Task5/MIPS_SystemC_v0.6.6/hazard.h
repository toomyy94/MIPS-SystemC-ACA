...
SC_MODULE( hazard )
{
  public: 
    ...
    sc_in< sc_uint<5> >  WriteReg_exe, WriteReg_mem/* WriteReg_id2, WriteReg_wb*/;
 	sc_in< sc_uint<3> > Jump; 
    sc_in< bool >  RegWrite_wb,  MemRead_mem , MemRead_exe, MemWrite, RegWrite_exe/*, RegWrite_mem*//*, mem_read, RegWrite*/;        
    sc_in< sc_uint<2> > JumpTaken;
    ...
    //tarefa 5
    //sc_in< bool >  lw_exe, lw_mem; /*thisIsSw,*/ 
    SC_CTOR(hazard)
    {      
        SC_METHOD(detect_hazard);
        sensitive << rs << rt 
		<< WriteReg_exe << RegWrite_exe /* << RegWrite */<< JumpTaken /*<< WriteReg_wb<< RegWrite_wb*/
		<< WriteReg_mem /*<< RegWrite_mem << mem_read*/ << /*WriteReg_id2 <<*/ MemRead_exe << MemRead_mem << MemWrite
		/*<< lw_exe << lw_mem *//*<< thisIsSw*/ << Jump; //tarefa5
